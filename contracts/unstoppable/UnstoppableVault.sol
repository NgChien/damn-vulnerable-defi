    ...
    ERC4626
{
    ...
    uint256 public constant FEE_FACTOR = 0.05 ether; // taxFree
    uint64 public constant GRACE_PERIOD = 30 days;

    uint64 public immutable end = uint64(block.timestamp) + GRACE_PERIOD;

    address public feeRecipient; // người nhận taxFree
    ...
    // kiểm tra tài sản == token (tham số truyền vào) nếu == thì trả tổng số tài sản , nếu không trả về 0
